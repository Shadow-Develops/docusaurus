...
Wonderful job, you have now gotten CDN Manager fully setup and ready to start. These steps should be very easy.
...
_Replace `cdnmanager` with whatever you named the folder._
...
You have now successfully setup and started CDN Manager! Now, you can enjoy setting up the rest of the settings within the admin panel.
