...
Configure what services to monitor in `monitors.json`. ShadowStatus supports 10 different monitor types for various use cases.
...
Monitor SSL/TLS certificate expiry for a domain.
...
| Property       | Type   | Default      | Description                                           |
| -------------- | ------ | ------------ | ----------------------------------------------------- |
| `target`       | string | **Required** | Domain name, optionally with port (`example.com:443`) |
| `warnDays`     | number | `14`         | Days before expiry to show a warning status           |
| `criticalDays` | number | `7`          | Days before expiry to show a critical/major status    |
...
| Property  | Type   | Default      | Description                                                       |
| --------- | ------ | ------------ | ----------------------------------------------------------------- |
| `target`  | string | **Required** | Server IP or hostname in `host:port` format (default port: 27015) |
...
| Property  | Type   | Default      | Description                                                       |
| --------- | ------ | ------------ | ----------------------------------------------------------------- |
| `target`  | string | **Required** | Server IP or hostname in `host:port` format (default port: 25565) |
