...
Now, head to `/etc/nginx/` and open the `ngnix.conf` file, then you will add `client_max_body_size 10G;` inside your `http` section.\
Your `http` section, if you've not made any other edits, will look like this:\
_Note: The 10G stands for 10 gigabytes, and you may modify this if you need to upload bigger files! Looking up the nginx documentation can be helpful._
